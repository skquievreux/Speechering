...
Name "Voice Transcriber v1.4.0"
OutFile "VoiceTranscriber_Installer_v1.4.0.exe"
Unicode True
...
Section "Voice Transcriber" SecApp
    ...
    WriteRegStr HKLM "Software\VoiceTranscriber" "Version" "1.4.0"
    WriteRegStr HKLM "Software\VoiceTranscriber" "InstallDate" "$0"

    ; Windows-Programme-Liste
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\VoiceTranscriber" "DisplayName" "Voice Transcriber v1.4.0"
    ...
    WriteRegStr HKLM "Software\Microsoft\Windows\CurrentVersion\Uninstall\VoiceTranscriber" "DisplayVersion" "1.4.0"
